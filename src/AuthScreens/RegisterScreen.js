...
import { View, StyleSheet, Text, ImageBackground, TextInput, TouchableOpacity, Dimensions, Alert } from 'react-native';
    ...
    return (
        <ImageBackground source={require('../../assets/login.png')} style={styles.backgroundImage}>
            ...
            <View style={styles.outerBox}>
                <Text style={styles.textStyle}>*Yaptığınız yorumlarda yalnızca isminizin ve soyisminizin baş harfleri gözükür.</Text>
                ...
                <TouchableOpacity style={styles.button} onPress={registerUser}>
                    <Text style={{ color: "white", fontWeight: "700", fontSize: 17}}>Kayıt Ol</Text>
                </TouchableOpacity>
            </View>
        </ImageBackground>
    );
